...
if(isset($_POST["donasi"])){
  ...
  $query=mysql_query("insert into tb_donasi values('','$_GET[id]','$_SESSION[id]','$_POST[jumlah]','$_POST[tanggal]','$_POST[comment]','$_POST[bank]','pending')") or die(mysql_error());
  if($query){
...
<div class="page-header"><h3 align="center">Tambah Galang</h3>
      ...
      <div class="form-group">
        <label for="jumlah" class="control-label col-sm-3">Jumlah Donasi</label>
        <div class="col-sm-8">
          <input type="text" name="jumlah" id="jumlah" class="form-control" placeholder="Masukan Jumlah Donasi anda">
        </div>  
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <input type="date" class="form-control" rows="3" name="tanggal" id="tanggal">
        </div>  
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <textarea class="form-control" rows="3" name="comment" id="comment" placeholder="Masukan Komentar Anda"></textarea>
        </div>  
      </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">
        <div class="col-sm-4">
        <input type="submit" id="donasi" name="donasi" class="btn btn-dark btn-block" value="Donasi Sekarang" />
        </div>
        <div class="col-sm-4">
