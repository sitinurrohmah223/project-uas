  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <ul class="dropdown-menu">
         <li><a href="tampildonasiuser.php"><span class="glyphicon glyphicon-gift"></span>Donasi Saya</a></li>
...
$start = ($page - 1) * $per_page;
 ...
 <div class="col-sm-4">
              ...
              <div class="panel-footer"><a href="donasi.php"><button class="btn btn-info" >Donasi</button></a></div>
            </div>
            </div>
              <?php } ?>
        </div>
