		...
		<div class="col-md-12">
			<div style="margin-bottom: 15px;" align="right">
				<form action="" method="post">
					<input type="text" name="inputan_pencarian" placeholder="Masukan Id Galang.." style="width: 200px; padding: 5px;" />
					<input type="submit" name="cari_galang" value="Cari" style="padding: 3px; background-color: #336666" />
				</form>
			</div>
		</div>
			...
			<tbody>
				...
				?>
					...
					<tr>
						...
						<td align="center">
							<a href="?page=galangadmin&action=edit&idgalang=<?php echo $data['id_galang']; ?>"><a class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-pencil"></span></a>
							<a onclick="return confirm('Yakin ingin menghapus data ?')" href="?page=galangadmin&action=hapus&idgalang=<?php echo $data['id_galang']; ?>"><a class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span></a>
						</td>
					</tr>
				<?php
				}
